...
export default function BulbRing({ progress = 1, size, className = '', ringClassName = '', label, children }) {
    ...
    return (
        <div
            ...
            aria-label={label}
        >
            <div className={`bulb-ring absolute inset-0 ${ringClassName}`} style={{ '--progress': `${clamped * 100}%` }} />
