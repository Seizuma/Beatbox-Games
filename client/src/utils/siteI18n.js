...
const strings = {
    fr: {
        ...
        beatboxdle: {
            ...
            // Forme courte pour la case de la grille, 68 px de large
            titlesShort: {
                'wbc-champion': 'Champion mondial',
                'wbc-runner-up': 'Finaliste mondial',
                'wbc-third': '3e mondial',
                'wbc-semi': 'Demi mondial',
                'wbc-quarter': 'Quart mondial',
                'wbc-entrant': 'Mondial',
                'gbb-champion': 'Champion GBB',
                'gbb-runner-up': 'Finaliste GBB',
                'gbb-third': '3e GBB',
                'gbb-semi': 'Demi GBB',
                'gbb-quarter': 'Quart GBB',
                'gbb-entrant': 'GBB',
            },
            // Forme longue pour la fiche de réponse
            titles: {
        ...
        admin: {
            ...
            beatboxdle: 'Beatboxdle — relancer le tirage',
            beatboxdleHelp: 'Outil de test',
            beatboxdleLetters: 'Relancer le mode lettres',
            beatboxdleClues: 'Relancer le mode indices',
            beatboxdleDone: 'Nouveau tirage en place. {cleared} résultat(s) effacé(s).',
        },
        notFound: {
    ...
    en: {
        ...
        beatboxdle: {
            ...
            titlesShort: {
                'wbc-champion': 'World champion',
                'wbc-runner-up': 'World finalist',
                'wbc-third': '3rd world',
                'wbc-semi': 'World semi',
                'wbc-quarter': 'World quarter',
                'wbc-entrant': 'Worlds',
                'gbb-champion': 'GBB champion',
                'gbb-runner-up': 'GBB finalist',
                'gbb-third': '3rd GBB',
                'gbb-semi': 'GBB semi',
                'gbb-quarter': 'GBB quarter',
                'gbb-entrant': 'GBB',
            },
            titles: {
                'wbc-champion': 'World champion',
                'wbc-runner-up': 'World championship runner-up',
                'wbc-third': '3rd at the world championship',
                'wbc-semi': 'World championship semi-finalist',
                'wbc-quarter': 'World championship quarter-finalist',
                'wbc-entrant': 'World championship entrant',
                'gbb-champion': 'GBB champion',
                'gbb-runner-up': 'GBB runner-up',
                'gbb-third': '3rd at GBB',
                'gbb-semi': 'GBB semi-finalist',
                'gbb-quarter': 'GBB quarter-finalist',
                'gbb-entrant': 'GBB entrant',
            },
            clues: {
                guess: 'Guess',
                country: 'Country',
        ...
        admin: {
            ...
            beatboxdle: 'Beatboxdle — reroll today',
