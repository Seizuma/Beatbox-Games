...
const strings = {
    fr: {
        ...
        stats: {
            ...
            sortNote: 'Trié par victoires, puis par points.',
            rank: 'Rang',
            player: 'Joueur',
            games: 'Parties',
            wins: 'Victoires',
            points: 'Points',
            emptyLeaderboard: 'Aucun joueur classé pour ce filtre.',
    ...
    en: {
        ...
        stats: {
            ...
            sortNote: 'Sorted by wins, then by points.',
            rank: 'Rank',
            player: 'Player',
            games: 'Games',
            wins: 'Wins',
            points: 'Points',
            emptyLeaderboard: 'No ranked players for this filter.',
            category: 'Game type',
            categoryAll: 'All',
